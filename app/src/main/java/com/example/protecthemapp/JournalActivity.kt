...
import com.example.protecthemapp.Utils.Utils
...
class JournalActivity : AppCompatActivity() {
    ...
    private var rarityTypes = mapOf(Pair(0, "Verbal abuse"), Pair(1, "Sexual abuse"), Pair(2, "Physical abuse"))
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                when (sortNames[position]) {
                    ...
                    "SORT BY ABUSE" -> loadIntoList("ORDER BY rarity DESC")
    ...
    fun loadIntoList(orderBy: String) {
        ...
        if (birdList.count() == 0) {
            textView.text = "Add a Journal entry."
        } else {
            textView.visibility = View.GONE

            customAdapter = CustomAdapter(this@JournalActivity, birdList)
            ...
            findViewById<ListView>(R.id.listView).setOnItemClickListener { _, _, i, _ ->
                ...
                intent.putExtra("abuse", rarityTypes[birdList[+i].rarity])
...
//(Android SQLite database in kotlin (2021))


//Android SQLite database in kotlin (2021) GeeksforGeeks.
// Available at: https://www.geeksforgeeks.org/android-sqlite-database-in-kotlin/
