...
class DetailsActivity : AppCompatActivity() {
    ...
    private var rarityTypes =
        mapOf(Pair("Verbal abuse", 0), Pair("Sexual abuse", 1), Pair("Physical abuse", 2))
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        raritySpinner.setSelection(rarityTypes["Verbal abuse"]!!)
        ...
        if (intent.hasExtra("id")) {
            ...
            raritySpinner.setSelection(rarityTypes[intent.getStringExtra("abuse")]!!)
...
//(How do you initialize a bitmap in kotlin(android)? (no date))
    fun delete(v: View) {
...
//How do you initialize a bitmap in kotlin(android)? (no date) Stack Overflow.
// Available at: https://stackoverflow.com/questions/66973113/how-do-you-initialize-a-bitmap-in-kotlinandroid
